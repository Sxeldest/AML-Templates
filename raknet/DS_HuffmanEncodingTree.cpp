...
RakNetDataStructures::HuffmanEncodingTree::HuffmanEncodingTree()
{
	root = 0;
}
...
void RakNetDataStructures::HuffmanEncodingTree::FreeMemory( void )
{
	if ( root == 0 )
		return ;
		
	// Use an in-order traversal to delete the tree
	RakNetDataStructures::Queue<HuffmanEncodingTreeNode *> nodeQueue;
...
void RakNetDataStructures::HuffmanEncodingTree::GenerateFromFrequencyTable( unsigned int frequencyTable[ 256 ] )
{
	int counter;
	HuffmanEncodingTreeNode * node;
	...
	RakNetDataStructures::LinkedList<HuffmanEncodingTreeNode *> huffmanEncodingTreeNodeList;
...
void RakNetDataStructures::HuffmanEncodingTree::EncodeArray( unsigned char *input, unsigned sizeInBytes, RakNet::BitStream * output )
{		
	unsigned counter;
...
unsigned RakNetDataStructures::HuffmanEncodingTree::DecodeArray( RakNet::BitStream * input, unsigned sizeInBits, unsigned maxCharsToWrite, unsigned char *output )
{
	HuffmanEncodingTreeNode * currentNode;
...
void RakNetDataStructures::HuffmanEncodingTree::DecodeArray( unsigned char *input, unsigned sizeInBits, RakNet::BitStream * output )
{
	HuffmanEncodingTreeNode * currentNode;
	...
	RakNet::BitStream bitStream( input, SAMP_BITS_TO_BYTES(sizeInBits), false );
...
void RakNetDataStructures::HuffmanEncodingTree::InsertNodeIntoSortedList( HuffmanEncodingTreeNode * node, RakNetDataStructures::LinkedList<HuffmanEncodingTreeNode *> *huffmanEncodingTreeNodeList ) const
{
	if ( huffmanEncodingTreeNodeList->Size() == 0 )
	{
