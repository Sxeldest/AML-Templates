...
/// The namespace RakNetDataStructures was only added to avoid compiler errors for commonly named data structures
/// As these data structures are stand-alone, you can use them outside of RakNet for your own projects if you wish.
namespace RakNetDataStructures
{
	...
	{
	public:
		static void IMPLEMENT_DEFAULT_COMPARISON(void) {RakNetDataStructures::defaultMapKeyComparison<key_type>(key_type(),key_type());}
		...
		// Has to be a static because the comparison callback for RakNetDataStructures::OrderedList is a C function
...
#pragma warning( disable : 4127 ) // warning C4127: conditional expression is constant
	...
	protected:
		RakNetDataStructures::OrderedList< key_type,MapNode,Map::NodeComparisonFunc > mapNodeList;
