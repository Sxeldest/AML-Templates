...
namespace RakNetDataStructures
{
	...
	{
	public:
		static void IMPLEMENT_DEFAULT_COMPARISON(void) {RakNetDataStructures::defaultOrderedListComparison<key_type, data_type>(key_type(),data_type());}
	...
	protected:
		RakNetDataStructures::List<data_type> orderedList;
	};
