...
static_assert(sizeof(RwStreamMemory) == 0xC);
...
static_assert(sizeof(RwStreamCustom) == 0x14);
#endif /* (!defined(DOXYGEN)) */
...
static_assert(sizeof(RwStream) == 0x24);
#endif /* (!defined(DOXYGEN)) */
...
static_assert(sizeof(RwMemory) == 0x8);
...
static_assert(sizeof(rwStreamGlobals) == 0x4);
