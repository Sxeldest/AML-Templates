...
static_assert(sizeof(RwFrame) == 0xA4, "RwFrame size must be 0xA4 for x32");
...
static_assert(sizeof(RwObjectHasFrame) == 0x14, "RwObjectHasFrame size must be 0x14 for x32");
...
static_assert(sizeof(RwFrustumPlane) == 0x14, "RwFrustumPlane size must be 0x14 for x32");
...
#endif /* (!defined(DOXYGEN)) */
static_assert(sizeof(RwCamera) == 0x188, "RwCamera size must be 0x188 for x32");
...
static_assert(sizeof(RwTexture) == 0x58, "RwTexture size must be 0x58 for x32");
