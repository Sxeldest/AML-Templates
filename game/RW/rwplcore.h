...
static_assert(sizeof(RpMaterial) == 0x1C, "RpMaterial size must be 0x1C for x32");
...
static_assert(sizeof(RpMaterialList) == 0xC, "RpMaterialList size must be 0xC for x32");
...
static_assert(sizeof(RpGeometry) == 0x64, "RpGeometry size must be 0x64 for x32");
