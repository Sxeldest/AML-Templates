...
static_assert(sizeof(RwRGBAReal) == 0x10, "RwRGBAReal size must be 0x10 for x32");
...
static_assert(sizeof(RwRGBA) == 0x4, "RwRGBA size must be 0x4 for x32");
...
{                                                                        \
    RwInt32 quantize;                                                    \
                                                                         \
    quantize = (RwInt32)( ((i)->red   * (RwReal)255.0)             \
                                + (RwReal)0.5 );                         \
    (o)->red   = (RwUInt8) quantize;                                     \
    quantize = (RwInt32)( ((i)->green * (RwReal)255.0)             \
                                + (RwReal)0.5 );                         \
    (o)->green = (RwUInt8) quantize;                                     \
    quantize = (RwInt32)( ((i)->blue  * (RwReal)255.0)             \
                                + (RwReal)0.5 );                         \
    (o)->blue  = (RwUInt8) quantize;                                     \
    quantize = (RwInt32)( ((i)->alpha * (RwReal)255.0)             \
                                + (RwReal)0.5 );                         \
