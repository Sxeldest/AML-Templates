...
static_assert(sizeof(RwImage) == 0x1C, "RwImage size must be 0x1C for x32");
...
static_assert(sizeof(rwImageFormat) == 0x34, "rwImageFormat size must be 0x34 for x32");
...
static_assert(sizeof(rwImageGlobals) == 0x220, "rwImageGlobals size must be 0x220 for x32");
