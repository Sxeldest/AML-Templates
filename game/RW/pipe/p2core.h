...
static_assert(sizeof(RxClusterDefinition) == 0x10);
/* RWPUBLICEND */
...
static_assert(sizeof(rxReq) == 0x14);
...
static_assert(sizeof(RwReqEntry) == 0x24);
...
static_assert(sizeof(RwScopeTrace) == 0x10);
/* RWPUBLIC */
...
static_assert(sizeof(RxOutputSpec) == 0xC);
/* RWPUBLICEND
...
static_assert(sizeof(RxClusterRef) == 0xC);
...
static_assert(sizeof(RxIoSpec) == 0x14);
 ...
 * \ref RxPipeline referencing that that pipeline node is unlocked.
 *
...
static_assert(sizeof(RxNodeMethods) == 0x1C);
...
static_assert(sizeof(RxNodeDefinition) == 0x40);
/***************************************************************************
 *
...
static_assert(sizeof(RxPipelineCluster) == 0x8);
...
static_assert(sizeof(RxCluster) == 0x1C);
...
static_assert(sizeof(RxPacket) == 0x30);
...
static_assert(sizeof(RxPipelineNode) == 0x28);
...
static_assert(sizeof(RxPipelineNodeTopSortData) == 0xC);
...
static_assert(sizeof(RxPipelineNodeParam) == 0x8);
...
static_assert(sizeof(RxExecutionContext) == 0x18);
...
static_assert(sizeof(RxPipelineRequiresCluster) == 0xC);
...
static_assert(sizeof(RxPipeline) == 0x34);
/****************************************************************************
 * Global Prototypes
 */
