...
static_assert(sizeof(rxHeapFreeBlock) == 0x8);
...
static_assert(sizeof(rxHeapSuperBlockDescriptor) == 0xC);
...
static_assert(sizeof(RxHeap) == 0x1C);
...
static_assert(sizeof(rxHeapBlockHeader) == 0x20);
